...
e_tsip_err_t R_TSIP_TlsSVGenerateSessionKeySub(uint32_t *InData_Sel_CipherSuite, uint32_t *InData_MasterSecret, uint32_t *InData_ClientRandom, uint32_t *InData_ServerRandom, uint32_t *InData_MAC, uint32_t *InData_NonceExplicit, uint32_t *OutData_ClientMACKeyOperationCode, uint32_t *OutData_ServerMACKeyOperationCode, uint32_t *OutData_ClientEncKeyOperationCode, uint32_t *OutData_ServerEncKeyOperationCode, uint32_t* OutData_ClientIV, uint32_t* OutData_ServerIV)
{
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX65NHU_func100(change_endian_long(0xefb4c60cu), change_endian_long(0x332dc70bu), change_endian_long(0xf11c6507u), change_endian_long(0xba42a01du));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX65NHU_func102(change_endian_long(0x3aff14e7u), change_endian_long(0xfcc628a2u), change_endian_long(0xe56430f7u), change_endian_long(0x121a118fu));
    ...
    else
    {
        ...
        RX65NHU_func101(change_endian_long(0xbe671d9fu), change_endian_long(0xc1636f49u), change_endian_long(0xc258fd98u), change_endian_long(0x55eef35cu));
        ...
        RX65NHU_func100(change_endian_long(0x2592ca8du), change_endian_long(0x1bd36679u), change_endian_long(0x702223e2u), change_endian_long(0x7e27e971u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX65NHU_func102(change_endian_long(0x2f5a3cdeu), change_endian_long(0x2fc387f9u), change_endian_long(0x2548a6cdu), change_endian_long(0xbdc5bca4u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX65NHU_func102(change_endian_long(0xba79540au), change_endian_long(0x3f8edde2u), change_endian_long(0xf21587bdu), change_endian_long(0xef7c2c09u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_pc7_r1.prc
 *********************************************************************************************************************/
