...
e_tsip_err_t R_TSIP_VerifyFirmwareMacFinalSub(uint32_t *InData_Program, uint32_t *InData_MAC, uint32_t MAX_CNT)
{
    ...
    RX65NHU_func100(change_endian_long(0x270f57deu), change_endian_long(0x782af40du), change_endian_long(0xa4a4a297u), change_endian_long(0xed241721u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        TSIP.REG_13CH.WORD = 0x000002ffu;
        RX65NHU_func102(change_endian_long(0x3ddb04a8u), change_endian_long(0xea5ac9f7u), change_endian_long(0x6ad863b8u), change_endian_long(0x74b853edu));
    ...
    {
        RX65NHU_func102(change_endian_long(0xd25332ddu), change_endian_long(0x72c83792u), change_endian_long(0xbc295a5bu), change_endian_long(0x3ae88092u));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_p26f.prc
 *********************************************************************************************************************/
TSIP_SEC_DEFAULT
