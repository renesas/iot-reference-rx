...
*******************************************************************************************************************/ /**
* @details       RX65NHU F/W update Init
...
e_tsip_err_t R_TSIP_GenerateFirmwareMacInitSub(uint32_t *InData_KeyIndex, uint32_t *InData_SessionKey, uint32_t *InData_IV)
{
    ...
    else
    {
        ...
        RX65NHU_func101(change_endian_long(0xdd6dd34du), change_endian_long(0xad8404bcu), change_endian_long(0x13ff0c84u), change_endian_long(0x0f8e1296u));
        return TSIP_SUCCESS;
    }
}
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_p23i.prc
 *********************************************************************************************************************/
