...
e_tsip_err_t R_TSIP_TlsSVRootCertificateVerificationSub(uint32_t *InData_Sel_PubKeyType, uint32_t *InData_Certificates, uint32_t *InData_CertificatesLength, uint32_t *InData_Signature, uint32_t *InData_CertificatesInfo, const uint32_t *InData_DomainParam, uint32_t *OutData_PubKey)
{
    ...
    RX65NHU_func100(change_endian_long(0x05a0d8bbu), change_endian_long(0x255b2a26u), change_endian_long(0x68d31a9eu), change_endian_long(0x573f5bc0u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX65NHU_func102(change_endian_long(0x32cf80bau), change_endian_long(0x990e133cu), change_endian_long(0xf34f6e69u), change_endian_long(0x33444a20u));
    ...
    {
        RX65NHU_func102(change_endian_long(0xe793fb8cu), change_endian_long(0x3f5c6e82u), change_endian_long(0x6b54c9b3u), change_endian_long(0x3ee1a3dau));
        TSIP.REG_1B8H.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_pc0_r2.prc
 *********************************************************************************************************************/
