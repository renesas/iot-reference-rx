...
e_tsip_err_t R_TSIP_EcdsaSigunatureVerificationSub(uint32_t *InData_Cmd, uint32_t *InData_KeyIndex, uint32_t *InData_MsgDgst, uint32_t *InData_Signature, const uint32_t *InData_DomainParam)
{
    ...
    else
    {
        ...
        else
        {
            ...
            RX65NHU_func101(change_endian_long(0x7d4f108bu), change_endian_long(0xfb032f5au), change_endian_long(0x66e31483u), change_endian_long(0xca6491a4u));
            RX65NHU_func010(InData_DomainParam);
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_pf1_r3.prc
 *********************************************************************************************************************/
