...
<smc>
    ...
    <tool id="SWComponent" version="1.0.0.0">
        <configuration inuse="true" name="r_bsp">
            <component display="r_bsp" id="r_bsp7.54" version="7.54" uselatestversion="true">
        ...
        <configuration inuse="true" name="r_ether_rx">
            <component display="r_ether_rx" id="r_ether_rx1.24" version="1.24" uselatestversion="true">
