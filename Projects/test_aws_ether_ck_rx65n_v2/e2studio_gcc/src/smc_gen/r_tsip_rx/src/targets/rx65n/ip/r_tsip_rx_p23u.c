...
e_tsip_err_t R_TSIP_GenerateFirmwareMacUpdateSub(uint32_t *InData_UpProgram, uint32_t *OutData_Program, uint32_t MAX_CNT)
{
    ...
    RX65NHU_func101(change_endian_long(0x4db20e7bu), change_endian_long(0xda59fb0fu), change_endian_long(0x5d941d0au), change_endian_long(0x5b955fd8u));
    return TSIP_SUCCESS;
}
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_p23u.prc
 *********************************************************************************************************************/
