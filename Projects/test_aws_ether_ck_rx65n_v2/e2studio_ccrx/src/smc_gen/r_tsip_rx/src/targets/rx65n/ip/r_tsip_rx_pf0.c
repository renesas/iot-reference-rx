...
e_tsip_err_t R_TSIP_EcdsaSigunatureGenerateSub(uint32_t *InData_Cmd, uint32_t *InData_KeyIndex, uint32_t *InData_MsgDgst, const uint32_t *InData_DomainParam, uint32_t *OutData_Signature)
{
    ...
    {
        RX65NHU_func100(change_endian_long(0x25c32ad2u), change_endian_long(0x7f7b845au), change_endian_long(0x06b09db8u), change_endian_long(0x49d9ea1cu));
        TSIP.REG_28H.WORD = 0x00870001u;
        RX65NHU_func004(InData_DomainParam);
        ...
        RX65NHU_func103();
        RX65NHU_func100(change_endian_long(0x70968f2au), change_endian_long(0x5bb20bedu), change_endian_long(0xebd620d9u), change_endian_long(0x12e21e56u));
        ...
        RX65NHU_func100(change_endian_long(0xd3deb7dau), change_endian_long(0x1b963b99u), change_endian_long(0x2191d812u), change_endian_long(0xbfa68accu));
        RX65NHU_func005(InData_DomainParam);
        RX65NHU_func025(InData_DomainParam);
        ...
        RX65NHU_func100(change_endian_long(0x9d43562du), change_endian_long(0x50a823b4u), change_endian_long(0x5512a8d2u), change_endian_long(0xb41aef1du));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX65NHU_func102(change_endian_long(0x644db41fu), change_endian_long(0x714c40dbu), change_endian_long(0x061e32f5u), change_endian_long(0x15abfcb1u));
            TSIP.REG_1B8H.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX65NHU_func100(change_endian_long(0x64e9b47eu), change_endian_long(0x87969197u), change_endian_long(0x5f9ab16fu), change_endian_long(0x45cd4eedu));
            ...
            TSIP.REG_1CH.WORD = 0x00001f00u;
            TSIP.REG_1CH.WORD = 0x00210000u;
            RX65NHU_func100(change_endian_long(0x39840c31u), change_endian_long(0x62038240u), change_endian_long(0xb0fc9b73u), change_endian_long(0x00f8cc0du));
            TSIP.REG_1CH.WORD = 0x00400000u;
            TSIP.REG_1D0H.WORD = 0x00000000u;
            if (1u == (TSIP.REG_1CH.BIT.B22))
            {
                RX65NHU_func102(change_endian_long(0x3e4839a3u), change_endian_long(0xcd9cf1c8u), change_endian_long(0x0a5fa3c0u), change_endian_long(0xcb992bacu));
                TSIP.REG_1B8H.WORD = 0x00000040u;
                /* WAIT_LOOP */
                while (0u != TSIP.REG_18H.BIT.B12)
                {
            ...
            {
                RX65NHU_func100(change_endian_long(0x6f1f8917u), change_endian_long(0xc9b45adbu), change_endian_long(0xb8b7fb85u), change_endian_long(0x8b9f656fu));
                TSIP.REG_34H.WORD = 0x00000800u;
                TSIP.REG_24H.WORD = 0x800068d0u;
                /* WAIT_LOOP */
                while (0u != TSIP.REG_24H.BIT.B21)
                ...
                TSIP.REG_1CH.WORD = 0x00001800u;
                RX65NHU_func100(change_endian_long(0xe7c685d2u), change_endian_long(0x7e56de60u), change_endian_long(0x3946de70u), change_endian_long(0x730b659au));
                TSIP.REG_1CH.WORD = 0x00400000u;
                TSIP.REG_1D0H.WORD = 0x00000000u;
                if (1u == (TSIP.REG_1CH.BIT.B22))
                {
                    RX65NHU_func102(change_endian_long(0x5aa47a6cu), change_endian_long(0xf6f06f5eu), change_endian_long(0xe4c159feu), change_endian_long(0x73014b07u));
                    TSIP.REG_1B8H.WORD = 0x00000040u;
                    /* WAIT_LOOP */
                    while (0u != TSIP.REG_18H.BIT.B12)
                    {
                ...
                else
                {
                    ...
                    TSIP.REG_1CH.WORD = 0x00001f00u;
                    TSIP.REG_1CH.WORD = 0x00210000u;
                    RX65NHU_func100(change_endian_long(0x5a6ee5fcu), change_endian_long(0x6bdce2d0u), change_endian_long(0x74713867u), change_endian_long(0x34ccd730u));
                    TSIP.REG_1CH.WORD = 0x00400000u;
                    TSIP.REG_1D0H.WORD = 0x00000000u;
                    if (1u == (TSIP.REG_1CH.BIT.B22))
                    {
                        RX65NHU_func102(change_endian_long(0xef01d1d9u), change_endian_long(0xb00467bdu), change_endian_long(0x75fd42c1u), change_endian_long(0xd3e3b698u));
                        TSIP.REG_1B8H.WORD = 0x00000040u;
                        /* WAIT_LOOP */
                        while (0u != TSIP.REG_18H.BIT.B12)
                        {
                    ...
                    {
                        RX65NHU_func100(change_endian_long(0xbcb13373u), change_endian_long(0xe72a3d97u), change_endian_long(0x9d3126bau), change_endian_long(0x65b8cf37u));
                        ...
                        RX65NHU_func100(change_endian_long(0x2be0976cu), change_endian_long(0x0f363f38u), change_endian_long(0x706ae717u), change_endian_long(0xc9f2c7e4u));
                        ...
                        RX65NHU_func102(change_endian_long(0x9012e441u), change_endian_long(0xe5482084u), change_endian_long(0x06f6165fu), change_endian_long(0xbb121d60u));
                        TSIP.REG_1B8H.WORD = 0x00000040u;
                        /* WAIT_LOOP */
                        while (0u != TSIP.REG_18H.BIT.B12)
                        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_pf0_r2.prc
 *********************************************************************************************************************/
